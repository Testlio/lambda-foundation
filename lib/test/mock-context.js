...
module.exports = {
    /*
    * Returns a mock context that assumes a call to context.fail() or context.done() should fail the test.
    */
    ...
    /*
    * Returns a mock context that assumes a call to context.succeed() or context.done() should fail the test.
    */
    ...
    /*
    * Returns a mock context that assumes a call to context.succeed() or context.fail() should fail the test.
    */
